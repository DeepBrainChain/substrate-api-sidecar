...
const cleanup = async () => {
    ...
    const sidecarUnInstallPack = await (0, sidecarScriptApi_1.launchProcess)('yarn', procs, sasUnInstallPackOpts);
    ...
    const deleteTarball = await (0, sidecarScriptApi_1.launchProcess)('rm', procs, sasDeleteTarballOpts);
 ...
 */
const main = async () => {
    const { Failed, Success } = types_1.StatusCode;
    /**
     * Build sidecar
     */
    ...
    const sidecarPack = await (0, sidecarScriptApi_1.launchProcess)('yarn', procs, config_1.defaultSasPackOpts);
    ...
    const sidecarInstallPack = await (0, sidecarScriptApi_1.launchProcess)('yarn', procs, sasInstallPackOpts);
     ...
     */
    (0, sidecarScriptApi_1.setWsUrl)('wss://kusama-rpc.polkadot.io');
    ...
    const sidecarStart = await (0, sidecarScriptApi_1.launchProcess)(`${__dirname}/../../node_modules/.bin/substrate-api-sidecar`, procs, sasStartPackOpts);
...
//# sourceMappingURL=runYarnPack.js.map